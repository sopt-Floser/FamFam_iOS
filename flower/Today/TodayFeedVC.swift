...
extension TodayFeedVC: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        /*
        cell.postName.text = post.content?.userIdx
        cell.postDate.text = post.content?.createDate
        cell.postImage?.imageFromUrl(gsno(post.content.photoName), defaultImgPath: "")
        cell.postContent.text = post.content?.content
        cell.replyCount.text = post.content?.commentCount
        */
...
extension TodayFeedVC: UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        nextVC.postName = post.content?.userIdx
